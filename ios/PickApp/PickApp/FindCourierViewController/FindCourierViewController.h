...
@interface FindCourierViewController : UIViewController<GMSAutocompleteTableDataSourceDelegate, UISearchBarDelegate,UITextFieldDelegate,UIGestureRecognizerDelegate,JTCalendarDelegate>
...
@property (weak, nonatomic) IBOutlet UIImageView *addCourier;
